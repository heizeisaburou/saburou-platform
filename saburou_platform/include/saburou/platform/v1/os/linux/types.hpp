...
namespace saburou::platform::v1::os::linux {
 ...
 */
template <> struct std::formatter<saburou::platform::v1::os::linux::distro_info_t> {
    bool repr = false;
    ...
    auto format(const saburou::platform::v1::os::linux::distro_info_t &info, std::format_context &ctx) const {
        if (repr) {
