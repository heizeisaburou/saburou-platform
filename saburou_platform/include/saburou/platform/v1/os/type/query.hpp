...
#include <saburou/platform/v1/os/type/types.hpp>
...
#elif defined(SABUROU_PLATFORM_V1_OS_IOS_SIMULATOR)
    return type_t::ios_simulator;
#elif defined(SABUROU_PLATFORM_V1_OS_IOS)
    return type_t::ios;
#elif defined(SABUROU_PLATFORM_V1_OS_MACOS)
    return type_t::macos;
#elif defined(SABUROU_PLATFORM_V1_OS_ANDROID)
    return type_t::android;
#elif defined(SABUROU_PLATFORM_V1_OS_LINUX)
    return type_t::linux;
#elif defined(SABUROU_PLATFORM_V1_OS_FREEBSD)
    return type_t::freebsd;
#elif defined(SABUROU_PLATFORM_V1_OS_NETBSD)
    return type_t::netbsd;
#elif defined(SABUROU_PLATFORM_V1_OS_OPENBSD)
    return type_t::openbsd;
#elif defined(SABUROU_PLATFORM_V1_OS_DRAGONFLY)
    return type_t::dragonfly;
#elif defined(SABUROU_PLATFORM_V1_OS_WASM_EMSCRIPTEN)
    return type_t::emscripten;
#elif defined(SABUROU_PLATFORM_V1_OS_WASM_WASI)
    return type_t::wasi;
#else
 ...
 */
template <> struct std::formatter<saburou::platform::v1::os::type_t> {
    bool repr = false;
    ...
    auto format(const saburou::platform::v1::os::type_t &t, std::format_context &ctx) const {
        auto name = saburou::platform::v1::os::to_code_name(t);
