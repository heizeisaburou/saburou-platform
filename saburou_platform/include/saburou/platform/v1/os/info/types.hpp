 ...
 */
template <> struct std::formatter<saburou::platform::v1::os::version_t> {
    bool repr = false;
    ...
    auto format(const saburou::platform::v1::os::version_t &v, std::format_context &ctx) const {
        if (repr) {
 ...
 */
template <> struct std::formatter<saburou::platform::v1::os::info_t> {
    bool repr = false;
    ...
    auto format(const saburou::platform::v1::os::info_t &t, std::format_context &ctx) const {
        if (repr) {
            return std::format_to(
